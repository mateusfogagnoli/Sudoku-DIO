# Sudoku UI — Quick Start

Rápido: compile e abra a interface gráfica.
...
3) Se o PowerShell bloquear scripts, rode antes:
...
Pronto — a janela do jogo deve abrir com um puzzle de exemplo.

Arquivo principal da UI: `UIMain`
